...
@Mod(SkyOreTrees.MOD_ID)
public class SkyOreTrees {
    public static final String MOD_ID = "skyoretrees";
    ...
    @EventBusSubscriber(modid = SkyOreTrees.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
